                ...
                while ($post_type_data->have_posts()):
                    ...
                    <div class="col-md-4 col-sm-12 scrollimation scale-in d2 pull-left">
                        <div class="enigma_blog_thumb_wrapper">
                            ...
                            <?php } ?>
                            <?php
							$excerpt_len = get_theme_mod('excerpt_len', '300');
                            ...
                            <div class="enigma_blog_thumb_footer">
                                <ul class="enigma_blog_thumb_date">
                                    <li><i class="fa-solid fa-user"></i><a href="<?php echo esc_url(get_author_posts_url(get_the_author_meta('ID'))); ?>"><?php the_author(); ?></a>
                                    </li>
                                    <li><i class="fa-solid fa-clock"></i>
                                        <?php the_date(); ?>
                                    </li>
                                    <li>
                                        <i class="fa-solid fa-comments"></i><?php comments_popup_link('0', '1', '%', '', '-'); ?>
                                    </li>
                                </ul>
                            </div>
                        </div>
